...
Route::post('audiences/auth/forgot-password', [AudienceRegisterController::class, 'forgotPasswordPost']);
...
Route::post('audiences/odditor-campaign-participant/{campParticipant}/completed', [OdditorController::class, 'playOdditorTrivia']);
...
Route::group(["middleware" => ["auth:api"]], function () {
    Route::prefix('users/')->group(function () {
        ...
        Route::post('brand/{brand}/details', [BrandController::class, 'addDetailsToBrand']);
...
Route::middleware('auth:audience')->group(function () {
    ...
    Route::prefix('audiences/')->group(function () {
        ...
        Route::post("account-settings/profile/validate-otp", [ProfileController::class, "validateOtp"]);
